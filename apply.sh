...
yay -S xorg xorg-xinit qtile feh flameshot udiskie ntfs-3g ttf-font-awesome ttc-iosevka picom htop harfbuzz ttf-hack ttf-joypixels brightnessctl network-manager-applet ttf-ubuntu-font-family
